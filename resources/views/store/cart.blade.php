            ...
            <div class="col-md-7">
                ...
                <div class="billing-details">
                    <div class="section-title">
                        <h3 class="title">Form Pengiriman</h3>
                    </div>
                    ...
                    <div class="form-group">
                        <input class="input" type="tel" name="tel" id="tel" placeholder="No.Telephone">
                    </div>
                    <div class="form-group">
                        <input class="input" type="password" name="pass" id="pass" placeholder="Masukkan password">
                    </div>
                    <div class="form-group">
                        <input class="input" type="password" name="confirm_password" id="confirm_password" placeholder="Ulangi password">
                    </div>
